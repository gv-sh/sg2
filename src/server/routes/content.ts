...
function toContentApiData(content: any): ContentApiData {
  ...
  return {
    ...
    type: contentType,
    image_original_url: content.image_blob ? `/api/images/${content.id}/original` : undefined,
    image_thumbnail_url: content.image_blob ? `/api/images/${content.id}/thumbnail` : undefined,
